...
Game::Game(int ancho, int alto, std::string titulo)
{
    ...
    controlBodyAvatar->AplicarFuerza(force, origen_force);
    controlBodyAvatar->AplicarImpulso(impulso, origen_impulso);
...
void Game::InitPhysics()
{
    ...
    b2Body* arribaBody = Box2DHelper::CreateRectangularStaticBody(phyWorld, 100, 10);
    arribaBody->SetTransform(b2Vec2(50.0f, 0.0f), 0.0f);
    ...
    controlBody = Box2DHelper::CreateCircularDynamicBody(phyWorld, 5, 1.0f, 0.0, 1.0f);
